    ...
    <main className="max-w-2xl mx-auto p-8">
      ...
      {success ? (
        ...
        <div className="border rounded-xl p-6 flex flex-col gap-4">
          ...
          <button onClick={handlePreview} className="border py-2 rounded-lg hover:bg-gray-50">
            Ver preço
          </button>
          {preview && (
          ...
          {preview && (
            <button onClick={handleBook} className="bg-blue-600 text-white py-2 rounded-lg hover:bg-blue-700">
              Confirmar reserva
            </button>
          )}
        </div>
